      ...
      builder: (context, state) {
        switch(state.movieDetailsSate) {
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConstance.imaggeUrl(
          ...
          case RequestState.erorr:
            return Center(child: Text(state.moviDetailsMessage));
        }
      },
    );
  }
            ...
            (context, index) {
              ...
              return FadeInUp(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        ApiConstance.imaggeUrl(recommendation.backdropPath!),
